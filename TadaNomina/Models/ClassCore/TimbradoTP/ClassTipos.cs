...
namespace Delva.AppCode.TimbradoTurboPAC
{
    ...
    {
        public c_TipoHoras ObtenTipoHorasExtra(string ClaveConcepto)
        {
            c_TipoHoras TipoHoras = c_TipoHoras.Item01;
            switch (ClaveConcepto)
            {
                case "212":
        ...
        public c_TipoContrato ObtenTipoContrato(string TipoContrato)
        {
        ...
        public c_FormaPago ObtenFormaPago(string FormaPago)
        {
            c_FormaPago fp = c_FormaPago.Item99;
            switch (FormaPago)
            {
                case "01":
                    fp = c_FormaPago.Item01;
                    break;
                case "02":
                    fp = c_FormaPago.Item02;
                    break;
                case "03":
                    fp = c_FormaPago.Item03;
                    break;
                case "04":
                    fp = c_FormaPago.Item04;
                    break;
                case "05":
                    fp = c_FormaPago.Item05;
                    break;
                case "06":
                    fp = c_FormaPago.Item06;
                    break;
                case "08":
                    fp = c_FormaPago.Item08;
                    break;
                case "12":
                    fp = c_FormaPago.Item12;
                    break;
                case "13":
                    fp = c_FormaPago.Item13;
                    break;
                case "14":
                    fp = c_FormaPago.Item14;
                    break;
                case "15":
                    fp = c_FormaPago.Item15;
                    break;
                case "17":
                    fp = c_FormaPago.Item17;
                    break;
                case "23":
                    fp = c_FormaPago.Item23;
                    break;
                case "24":
                    fp = c_FormaPago.Item24;
                    break;
                case "25":
                    fp = c_FormaPago.Item25;
                    break;
                case "26":
                    fp = c_FormaPago.Item26;
                    break;
                case "27":
                    fp = c_FormaPago.Item27;
                    break;
                case "28":
                    fp = c_FormaPago.Item28;
                    break;
                case "29":
                    fp = c_FormaPago.Item29;
                    break;
                case "30":
                    fp = c_FormaPago.Item30;
                    break;
                case "99":
                    fp = c_FormaPago.Item99;
                    break;
                default:
                    fp = c_FormaPago.Item99;
                    break;
        ...
        public c_Moneda ObtenTipoMoneda(string tipoMoneda)
        {
            c_Moneda moneda = c_Moneda.MXN;
            switch (tipoMoneda)
            {
                case "MXN":
                    moneda = c_Moneda.MXN;
        ...
        public c_TipoDeComprobante ObtenTipoComprobante(string tipoComprobante)
        {
            c_TipoDeComprobante tipo = c_TipoDeComprobante.N;
            switch (tipoComprobante)
            {
                case "N":
                    tipo = c_TipoDeComprobante.N;
                    break;
                case "I":
                    tipo = c_TipoDeComprobante.I;
                    break;
                case "E":
                    tipo = c_TipoDeComprobante.E;
                    break;
                case "P":
                    tipo = c_TipoDeComprobante.P;
                    break;
                case "T":
                    tipo = c_TipoDeComprobante.T;
                    break;
                default:
                    tipo = c_TipoDeComprobante.N;
                    break;
        ...
        public c_MetodoPago ObtenMetodoPago(string metodoPago)
        {
            c_MetodoPago metodo = c_MetodoPago.PUE;
            switch (metodoPago)
            {
                case "PUE":
                    metodo = c_MetodoPago.PUE;
                    break;
                case "PPD":
                    metodo = c_MetodoPago.PPD;
                    break;
                default:
                    metodo = c_MetodoPago.PUE;
                    break;
