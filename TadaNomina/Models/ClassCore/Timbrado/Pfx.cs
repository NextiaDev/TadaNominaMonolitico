...
namespace TadaNomina.Models.ClassCore.Timbrado
{
    public class Pfx
    {
        ...
        public bool creaPFX()
        {
            ...
            {
                FileName = @"C:\openssl-win32\bin\openssl",
                Arguments = "x509 -inform DER -in \"" + cer + "\" -out \"" + ArchivoCPEM + "\"",
            ...
            {
                FileName = @"C:\openssl-win32\bin\openssl",
                Arguments = "pkcs8 -inform DER -in \"" + key + "\" -passin pass:" + clavePrivada + " -out \"" + ArchivoKPEM + "\"",
            ...
            {
                FileName = @"C:\openssl-win32\bin\openssl",
                Arguments = "pkcs12 -export -out \"" + ArchivoPFX + "\" -inkey \"" + ArchivoKPEM + "\" -in \"" + ArchivoCPEM + "\" -passout pass:" + clavePrivada
            });
            //proc3.WaitForExit();
