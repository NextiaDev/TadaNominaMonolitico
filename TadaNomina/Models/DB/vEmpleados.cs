...
namespace TadaNomina.Models.DB
{
    ...
    public partial class vEmpleados
    {
        ...
        public Nullable<int> ClienteAdministrado { get; set; }
        ...
        public string AClaveRH { get; set; }
        public string DClaveRH { get; set; }
        public string PClaveRH { get; set; }
        public string CCClaveRH { get; set; }
